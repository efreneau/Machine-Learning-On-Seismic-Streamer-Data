...
%For more information see github.com/efreneau/machinelearninguw
    ...
    fprintf(fileID,'Date,Time,Depth of Airgun(m),Depth of Reciever(m),X Airgun,Y Airgun,Z Airgun,X_R1,Y_R1,Z_R1,SPL1,SEL1,SPL2,SEL2,SPL3,SEL3,SPL4,SEL4,SPL_full,SEL_full,Peak_Index\n');%column names
